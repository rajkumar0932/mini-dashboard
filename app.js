        ...
        schedule: `
            ...
            <div class="card overflow-x-auto">
                <table class="schedule-table">
                    ...
                    <tbody>
                        <tr><td>9:00-10</td><td><span class="subject-eim">EIM(SB)</span></td><td><span class="subject-dsp">DSP(SRC)</span></td><td><span class="subject-eim">EIM(SB)</span></td><td><span class="subject-adc">ADC(TM)</span></td><td><span class="subject-mpmc">MPMC</span></td></tr>
                        <tr><td>10:00-11</td><td><span class="subject-dsp">DSP(SRC)</span></td><td><span class="subject-eim">EIM(SB)</span></td><td><span class="subject-im">IM(BI)</span></td><td><span class="subject-mpmc">MPMC</span></td><td><span class="subject-adc">ADC(TM)</span></td></tr>
                        <tr><td>11:00-12</td><td><span class="subject-adc">ADC(TM)</span></td><td><span class="subject-im">IM(ABC)</span></td><td><span class="subject-mpmc-lab">MPMC LAB</span></td><td><span class="subject-dsp">DSP</span></td><td><span class="subject-eim-lab">EIM LAB</span></td></tr>
                        <tr><td>12:00-1</td><td><span class="subject-im">IM(ABC)</span></td><td><span class="subject-mpmc">MPMC</span></td><td><span class="subject-mpmc-lab">MPMC LAB</span></td><td><span class="subject-break">BREAK</span></td><td><span class="subject-eim-lab">EIM LAB</span></td></tr>
                        <tr><td>1:00-2</td><td><span class="subject-break">BREAK</span></td><td><span class="subject-break">BREAK</span></td><td><span class="subject-break">BREAK</span></td><td><span class="subject-break">BREAK</span></td><td><span class="subject-break">BREAK</span></td></tr>
                        <tr><td>2:00-3</td><td><span class="subject-mpmc">MPMC</span></td><td><span class="subject-dsp-lab">DSP LAB</span></td><td><span class="subject-dsp">DSP(SRC)</span></td><td><span class="subject-adc-lab">ADC LAB</span></td><td><span class="subject-eim">EIM(SB)</span></td></tr>
                        <tr><td>3:00-4</td><td><span class="subject-mini-project">Mini Project</span></td><td><span class="subject-dsp-lab">DSP LAB</span></td><td><span class="subject-adc">ADC(TM)</span></td><td><span class="subject-adc-lab">ADC LAB</span></td><td><span class="subject-break">BREAK</span></td></tr>
                        <tr><td>4:00-5</td><td><span class="subject-mini-project">Mini Project</span></td><td><span class="subject-break">BREAK</span></td><td><span class="subject-break">BREAK</span></td><td><span class="subject-break">BREAK</span></td><td><span class="subject-break">BREAK</span></td></tr>
                    </tbody>
                </table>
            </div>
        `,
